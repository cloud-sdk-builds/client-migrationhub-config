...
[`@aws-sdk/client-migrationhub-config`](https://www.npmjs.com/package/@aws-sdk/client-migrationhub-config/v/3.1129.0).
...
- @aws-sdk/client-migrationhub-config v3.1129.0 - [https://cloud-sdk-builds.github.io/?sdk=client-migrationhub-config&version=3.1129.0](https://cloud-sdk-builds.github.io/?sdk=client-migrationhub-config&version=3.1129.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1129.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HBSdKCodmhy1K+pdYtHeHT+h0rL3h0tNhw/mFQF1CZNPFH2yovAdeXxR+9NB4uAC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-migrationhub-config": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1129.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1129.0/index.min.mjs": "sha384-HBSdKCodmhy1K+pdYtHeHT+h0rL3h0tNhw/mFQF1CZNPFH2yovAdeXxR+9NB4uAC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-migrationhub-config/blob/refs/tags/3.1129.0/LICENSE
```
