...
[`@aws-sdk/client-migrationhub-config`](https://www.npmjs.com/package/@aws-sdk/client-migrationhub-config/v/3.1133.0).
...
- @aws-sdk/client-migrationhub-config v3.1133.0 - [https://cloud-sdk-builds.github.io/?sdk=client-migrationhub-config&version=3.1133.0](https://cloud-sdk-builds.github.io/?sdk=client-migrationhub-config&version=3.1133.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1133.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iO5OhV6VWsp1up8lRy+0qkh4/9i8iOQn4gy9I3qcDc9w22Ui/ElL7p3qoiKjeTkZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-migrationhub-config": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1133.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1133.0/index.min.mjs": "sha384-iO5OhV6VWsp1up8lRy+0qkh4/9i8iOQn4gy9I3qcDc9w22Ui/ElL7p3qoiKjeTkZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-migrationhub-config/blob/refs/tags/3.1133.0/LICENSE
```
