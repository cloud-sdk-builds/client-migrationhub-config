...
[`@aws-sdk/client-migrationhub-config`](https://www.npmjs.com/package/@aws-sdk/client-migrationhub-config/v/3.1111.0).
...
- @aws-sdk/client-migrationhub-config v3.1111.0 - [https://cloud-sdk-builds.github.io/?sdk=client-migrationhub-config&version=3.1111.0](https://cloud-sdk-builds.github.io/?sdk=client-migrationhub-config&version=3.1111.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1111.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rcZzDht0t44kBXkVHsKjLN7ot/fvGEzK2JgznbvvCTIeJEGnQNHMXujk7C3a4iST
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-migrationhub-config": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1111.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1111.0/index.min.mjs": "sha384-rcZzDht0t44kBXkVHsKjLN7ot/fvGEzK2JgznbvvCTIeJEGnQNHMXujk7C3a4iST"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-migrationhub-config/blob/refs/tags/3.1111.0/LICENSE
```
