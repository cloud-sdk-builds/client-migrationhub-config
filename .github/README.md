...
[`@aws-sdk/client-migrationhub-config`](https://www.npmjs.com/package/@aws-sdk/client-migrationhub-config/v/3.1084.0).
...
- @aws-sdk/client-migrationhub-config v3.1084.0 - [https://cloud-sdk-builds.github.io/?sdk=client-migrationhub-config&version=3.1084.0](https://cloud-sdk-builds.github.io/?sdk=client-migrationhub-config&version=3.1084.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1084.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7QV1TAmgBtSfY/NCPaNkTWhoj1HMe4CSiZeT49gbb4IASyV+gU3/y+USJfZFVieB
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-migrationhub-config": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1084.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1084.0/index.min.mjs": "sha384-7QV1TAmgBtSfY/NCPaNkTWhoj1HMe4CSiZeT49gbb4IASyV+gU3/y+USJfZFVieB"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-migrationhub-config";
...
```
https://github.com/cloud-sdk-builds/client-migrationhub-config/blob/refs/tags/3.1084.0/LICENSE
```
