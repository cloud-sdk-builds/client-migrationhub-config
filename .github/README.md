...
[`@aws-sdk/client-migrationhub-config`](https://www.npmjs.com/package/@aws-sdk/client-migrationhub-config/v/3.1120.0).
...
- @aws-sdk/client-migrationhub-config v3.1120.0 - [https://cloud-sdk-builds.github.io/?sdk=client-migrationhub-config&version=3.1120.0](https://cloud-sdk-builds.github.io/?sdk=client-migrationhub-config&version=3.1120.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1120.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j+kUmIZbnKZI7Y/BcI8QRZxdxENxyDZErEU7jFLo5BdUAKGu8Rwo1r8pIaj/p7hq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-migrationhub-config": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1120.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.1120.0/index.min.mjs": "sha384-j+kUmIZbnKZI7Y/BcI8QRZxdxENxyDZErEU7jFLo5BdUAKGu8Rwo1r8pIaj/p7hq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-migrationhub-config/blob/refs/tags/3.1120.0/LICENSE
```
