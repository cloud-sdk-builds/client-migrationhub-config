...
[`@aws-sdk/client-migrationhub-config`](https://www.npmjs.com/package/@aws-sdk/client-migrationhub-config/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9xOiZ2xQ5Z/hsgfKJ6ZkCzRff2d48rJlE+pnBPAmVfTUk77uZPSZO1YqIXlhcwtd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-migrationhub-config": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migrationhub-config@3.624.0/index.min.mjs": "sha384-9xOiZ2xQ5Z/hsgfKJ6ZkCzRff2d48rJlE+pnBPAmVfTUk77uZPSZO1YqIXlhcwtd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-migrationhub-config/blob/refs/tags/3.624.0/LICENSE
```
